...
delete from electronic_image_documents;
delete from electronic_image_change_notices;
delete from electronic_image_data;
...
values ('wb-465', '2018-04-20', 'ACC_COPY', null, '49/SZ-123789', 1007),
       ...
       ('wb-546', '2019-06-20', 'ACC_COPY', 'true remark', '49/SZ-1289', 1008);
