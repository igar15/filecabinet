...
public class InternalDispatchTestData {
    ...
    public static final InternalDispatch INTERNAL_DISPATCH2 = new InternalDispatch(INTERNAL_DISPATCH1_ID + 1, "wb-532", LocalDate.of(2018, 4, 20),
            Status.ACC_COPY, "simple remark", Stamp.V, DepartmentTestData.DEPARTMENT_2, null, LocalDate.of(2020, 1, 15), "Naumkin", "1-31-65", true, "БА1.640.016-01");
    public static final InternalDispatch INTERNAL_DISPATCH3 = new InternalDispatch(INTERNAL_DISPATCH1_ID + 2, "wb-556", LocalDate.of(2019, 6, 20),
            Status.ACC_COPY, "true remark", null, DepartmentTestData.DEPARTMENT_2, null, LocalDate.of(2020, 4, 18), "Fatelnikova", "1-34-68", true, "БА1.640.020-03");
    ...
    public static InternalDispatch getNew() {
        return new InternalDispatch(null, "wb-54", LocalDate.of(2017, 4, 15),
                Status.ACC_COPY, null, Stamp.II, DepartmentTestData.DEPARTMENT_1, null, LocalDate.of(2020, 4, 18), "Fatelnikova", "1-34-68", true, "БА1.640.020-03");
    }

    public static InternalDispatch getNewWithDuplicateStampAndDocument() {
        return new InternalDispatch(null, "wb-54", LocalDate.of(2017, 4, 15),
                Status.ACC_COPY, null, Stamp.V, DepartmentTestData.DEPARTMENT_1, null, LocalDate.of(2020, 4, 18), "Fatelnikova", "1-34-68", true, "БА1.640.016-01");
    ...
    public static List<InternalDispatch> getNewsWithWrongValues() {
        return List.of(
                new InternalDispatch(null, "", LocalDate.of(2017, 4, 15),
                        Status.ACC_COPY, null, Stamp.I, null, null, LocalDate.of(2020, 4, 18), "Fatelnikova", "1-34-68", true, "Singly"),
                ...
                new InternalDispatch(null, "wb-22", LocalDate.of(2017, 4, 15),
                        null, null, Stamp.I, null, null, LocalDate.of(2020, 4, 18), "Fatelnikova", "1-34-68", true, "Singly")
        );
    }

    public static InternalDispatch getUpdated() {
        return new InternalDispatch(INTERNAL_DISPATCH1_ID, "wb-545", LocalDate.of(2014, 4, 15),
                Status.ACC_COPY, null, Stamp.I, DepartmentTestData.DEPARTMENT_2, null, LocalDate.of(2020, 4, 18), "Fatelnikova", "1-34-68", true, "БА1.640.020-03");
    }
